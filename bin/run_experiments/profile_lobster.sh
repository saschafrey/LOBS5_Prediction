python -m cProfile -o program.prof run_train.py --C_init=trunc_standard_normal --prenorm=True --batchnorm=True --bidirectional=True \
                    --blocks=8 --bsz=16 --d_model=128 --dataset=lobster-prediction \
                    --dir_name='./data/test' --clip_eigs=True \
